...
- Resolve `FRCV-2026-04-18-005`: root-cause the continuous-frame `FRCV_SCB_CASE_END` pending-queue warnings and decide whether they need harness cleanup or a downgraded/report-only classification.
