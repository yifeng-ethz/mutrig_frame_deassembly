# ⚠️ bucket_frame_error_cfg_d

**Kind:** `bucket_frame` &nbsp; **Build:** `CFG_D` &nbsp; **Bucket:** `ERROR` &nbsp; **Sequence:** `ERROR_CFG_D`
...
|---:|---|---|---|---:|---|
| 1 | `X119_cfgD_channel_width8_random_wide_values` | `` | 34.38 | 11 | hit_eop |
| 2 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 1 | hit_eop |
| 3 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
| 4 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
| 5 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
| 6 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
| 7 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
| 8 | `X119_cfgD_channel_width8_random_wide_values` | `` | 37.50 | 0 | hit_eop |
