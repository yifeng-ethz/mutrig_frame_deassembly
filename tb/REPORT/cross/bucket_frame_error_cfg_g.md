# ⚠️ bucket_frame_error_cfg_g

**Kind:** `bucket_frame` &nbsp; **Build:** `CFG_G` &nbsp; **Bucket:** `ERROR` &nbsp; **Sequence:** `ERROR_CFG_G`
...
|---:|---|---|---|---:|---|
| 1 | `X124_cfgG_debuglv2_functional_delta_negative` | `` | 34.38 | 11 | hit_eop |
