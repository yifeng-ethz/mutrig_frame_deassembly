# ⚠️ bucket_frame_prof_cfg_e

**Kind:** `bucket_frame` &nbsp; **Build:** `CFG_E` &nbsp; **Bucket:** `PROF` &nbsp; **Sequence:** `PROF_CFG_E`
...
|---:|---|---|---|---:|---|
| 1 | `P085_cfgE_addr1_poll_soak` | `` | 34.38 | 11 | hit_eop |
...
| 33 | `P090_cfgE_control_churn_soak` | `` | 37.50 | 0 | hit_eop |
