# ✅ all_buckets_frame_cfg_d

**Kind:** `all_buckets_frame` &nbsp; **Build:** `CFG_D` &nbsp; **Bucket:** `-` &nbsp; **Sequence:** `ALL_CFG_D`
...
|---:|---|---|---|---:|---|
| 1 | `E097_channel_width8_large_channel_passthrough` | `` | 34.38 | 11 | hit_eop |
| 2 | `P084_cfgD_channel8_wide_sweep` | `` | 37.50 | 1 | hit_eop |
| 3 | `P089_cfgD_zerohit_onehit_mix` | `` | 37.50 | 0 | hit_eop |
| 4 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 40.62 | 1 | hit_eop |
| 5 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 53.12 | 4 | hit_eop |
| 6 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 56.25 | 1 | hit_eop |
| 7 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 56.25 | 0 | hit_eop |
| 8 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 1 | hit_eop |
...
| 19 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 20 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 21 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 22 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 23 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 24 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 25 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 26 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
| 27 | `P128_seed11_cfgD_wide_channel_100k_cycles` | `` | 59.38 | 0 | hit_eop |
