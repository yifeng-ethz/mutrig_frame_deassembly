# ⚠️ bucket_frame_error_cfg_c

**Kind:** `bucket_frame` &nbsp; **Build:** `CFG_C` &nbsp; **Bucket:** `ERROR` &nbsp; **Sequence:** `ERROR_CFG_C`
...
|---:|---|---|---|---:|---|
| 1 | `X118_cfgC_channel_width1_invalid_channel_drive` | `` | 34.38 | 11 | hit_eop |
