# ⚠️ bucket_frame_error_cfg_e

**Kind:** `bucket_frame` &nbsp; **Build:** `CFG_E` &nbsp; **Bucket:** `ERROR` &nbsp; **Sequence:** `ERROR_CFG_E`
...
|---:|---|---|---|---:|---|
| 1 | `X120_cfgE_addrwidth1_highaddr_alias_misuse` | `` | 34.38 | 11 | hit_eop |
