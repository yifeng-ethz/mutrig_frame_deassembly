...
- **Scenario:** `CFG_C`, repeated stop mid-frame
- **Primary checks:** min-width channel build still honors stop contract
- **Contract anchor:** channel generic + termination
...
| toggle | 35.32 | 4.41 | 0.00 | 53.95 | 0.00 |
