...
**Bucket:** `ERROR` &nbsp; **Method:** `F` &nbsp; **Build:** `CFG_E` &nbsp; **Effort:** `practical` &nbsp; **Result:** `pass`

## Intent

- **Scenario:** Build `CSR_ADDR_WIDTH=1`, issue software accesses above range
- **Primary checks:** aliasing behavior is documented and deterministic
...
| toggle | 16.39 | 16.39 | 0.00 | 51.70 | 0.00 |
