# ✅ P096_channel_rotate_sparse

**Bucket:** `PROF` &nbsp; **Method:** `S` &nbsp; **Build:** `CFG_A` &nbsp; **Effort:** `practical` &nbsp; **Result:** `pass`

## Intent

- **Scenario:** use nonconsecutive channels only
- **Primary checks:** no hidden dependence on contiguous channels
...
| toggle | 15.80 | 15.80 | 0.00 | 61.46 | 0.00 |
