...
- **Scenario:** Change `asi_ctrl_data` while `valid=0`
- **Primary checks:** prior run state is held
- **Contract anchor:** `else run_state_cmd <= run_state_cmd`
...
| toggle | 16.16 | 16.16 | 0.00 | 43.64 | 0.00 |
